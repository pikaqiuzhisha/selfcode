...
public class WXPayUtil {
     ...
     *      
     */
    public static String wxPayRefund(String out_trade_no, String transaction_id, String out_refund_no, String total_fee) {
        StringBuffer xml = new StringBuffer();
        String data = null;
        try {
            ...
            parameters.put("sign", createSign(parameters, WXPayConstants.API_KEY));
            parameters.put("notify_url", "https://weixin.qq.com/notify/");
     ...
     *      
     */
    public static String wxPayRefund(String out_trade_no, String transaction_id, String out_refund_no, String total_fee, String refund_fee) {
        StringBuffer xml = new StringBuffer();
        String data = null;
        try {
            String nonceStr = genNonceStr();//生成32位随机字符串
    ...
    public static String wxPayBack(String url, String data) throws Exception {
        ...
        try {
            ...
            StringEntity entities = new StringEntity(data);
            httppost.setEntity((HttpEntity) entities);
