...
public class ChargeOrder {
    ...
    public void paySetter(int payment, int paymentAct, int virtualPayment, int paySrc, int payStatus, int orderStatus, int payType, String feeDetailSnap, String payedOrderAt) {
    ...
    public void refundSetter(int payment, int paymentAct, int virtualPayment, int refundAct, int virtualRefund, int orderType, int payStatus, int orderStatus, String refundOrderAt) {
        this.setPayment(payment);
        this.setPaymentAct(paymentAct);
        this.setVirtualPayment(virtualPayment);
        this.setRefundAct(refundAct);
        this.setVirtualRefund(virtualRefund);
